...
| `council_intraday_replay.py` | إعادة سببية من شموع MT5 ومحاكاة TP1/SL/خروج 4h المطابقة للتنفيذ |
| `strategy_promotion.py` | بوابة ترقية موضوعية؛ تمنع إرسال Demo عند فشل holdout/forward أو تركز الإشارات |
...
هذا النظام أداة تحليل ومساعد قرار — **ليس توصية مالية ولا بديلاً عن حكمك**.
النتائج التاريخية لا تضمن الأداء المستقبلي. إرسال أوامر Demo الآلي يفشل بشكل
آمن ما لم يكن `data_cache/strategy_promotion_report.json` ناجحاً؛ الوضع الحالي
Shadow فقط بعد فشل الفترة الأمامية 2025-10 إلى 2026-09.
