...
ALIASES: Dict[str, Tuple[str, ...]] = {
    ...
    "BAI_BASE_URL":       ("BAI_BASE_URL",),
    "BAI_MODEL":          ("BAI_MODEL",),
    "GOROUTER_API_KEY":   ("GOROUTER_API_KEY",),
    "GOROUTER_BASE_URL":  ("GOROUTER_BASE_URL",),
    "GOROUTER_MODEL":     ("GOROUTER_MODEL",),
    "KKTOKEN_API_KEY":    ("KKTOKEN_API_KEY",),
    "KKTOKEN_BASE_URL":   ("KKTOKEN_BASE_URL",),
    "KKTOKEN_MODEL":      ("KKTOKEN_MODEL",),
